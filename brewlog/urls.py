...
rules = [
    ...
    ('/profile/<int:userid>/breweries',
        dict(endpoint='profile-breweries', view_func=LazyView('brewlog.users.views.breweries'))),
    ('/profile/<int:userid>/brews',
        dict(endpoint='profile-brews', view_func=LazyView('brewlog.users.views.brews'))),
    ('/brewery/add',
