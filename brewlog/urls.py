...
from brewlog.users.views import select_provider, public_profile, dashboard, logout, remote_login, remote_login_callback
...
rules = [
    ...
    ('/profile', dict(endpoint='profile', view_func=public_profile)),
