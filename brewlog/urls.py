...
rules = [
    ...
    ('/profile',
        dict(endpoint='profile', view_func=LazyView('brewlog.users.views.profile'))),
    ('/profile/<userid>',
        dict(endpoint='profile-details', view_func=LazyView('brewlog.users.views.dashboard'), methods=['POST', 'GET'])),
    ('/brewery/add',
