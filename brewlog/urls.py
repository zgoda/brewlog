...
rules = [
    ...
    ('/profile/<userid>',
        dict(endpoint='profile-details', view_func=LazyView('brewlog.users.views.profile'), methods=['POST', 'GET'], defaults={'slug': None})),
    ('/profile/<userid>/<slug>',
    ...
    ('/brewery/<brewery_id>',
        dict(endpoint='brewery-details', view_func=LazyView('brewlog.brewing.views.brewery'), methods=['POST', 'GET'], defaults={'slug': None})),
    ('/brewery/<brewery_id>/<slug>',
    ...
    ('/brew/<brew_id>',
        dict(endpoint='brew-details', view_func=LazyView('brewlog.brewing.views.brew'), methods=['POST', 'GET'], defaults={'slug': None})),
    ('/brew/<brew_id>/<slug>',
