...
rules = UrlMap([
    ...
    Rule('/brew/<int:brew_id>/tastingnote/add',
        dict(endpoint='brew-tastingnote-add', view_func='brewlog.brewing.views.brew_add_tasting_note', methods=['POST', 'GET'])),
    Rule('/brew/tastingnote/<int:note_id>/delete',
        dict(endpoint='brew-tastingnote-delete', view_func='brewlog.brewing.views.brew_delete_tasting_note', methods=['POST', 'GET'])),
    Rule('/brew/tastingnote/ajaxupdate',
        dict(endpoint='brew-tastingnote-update', view_func='brewlog.brewing.views.brew_update_tasting_note', methods=['POST'])),
    Rule('/brew/tastingnote/ajaxtext',
        dict(endpoint='brew-tastingnote-loadtext', view_func='brewlog.brewing.views.brew_load_tasting_note_text')),
    Rule('/brew/add',
